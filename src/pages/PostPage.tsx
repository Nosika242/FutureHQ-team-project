...
export default function PostPage(): React.JSX.Element {
  ...
  return (
    <section className="h-full min-h-screen md:h-[calc(100vh-80px)] flex flex-col transition-transform duration-300 w-full">
        ...
        <div
          className={`flex-1 ${
            isPanelOpen
              ...
              : "md:flex-1 xl:px-30 lg:px-6 md:px-5 md:pt-12 px-4 pt-6"
